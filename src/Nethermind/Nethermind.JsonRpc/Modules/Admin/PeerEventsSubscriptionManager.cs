...
{
    public class PeerEventsSubscriptionManager : ISubscriptionManager
    {
        ...
        public PeerEventsSubscriptionManager(ISubscriptionFactory? subscriptionFactory, ILogManager? logManager)
        {
